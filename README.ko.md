...
> 🌐 웹 구독 페이지: **<https://hh-io.github.io/lol-esports-calendar/>** (지역별 구독 링크와 구독 방법 포함).
...
이 프로젝트의 **코드**는 [MIT](LICENSE) 라이선스로 배포됩니다.

일정 데이터는 lolesports에서 가져오며 저작권은 Riot Games 및 관련 당사자에게 있습니다. 본 프로젝트는 형식 변환만 수행하고 데이터에 대한 어떠한 권리도 주장하지 않으며, Riot Games와 제휴하거나 보증 관계에 있지 않습니다.
